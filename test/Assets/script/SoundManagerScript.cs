...
public class SoundManagerScript : MonoBehaviour
{
    ...
    public static AudioClip messer_A,dinoWalk,blut1,blutPlatz,crossbow,jump,hit,steinwurf,Wulolo;
    ...
    void Start()
    {
        ...
        Wulolo = Resources.Load<AudioClip>("Wulolo");
